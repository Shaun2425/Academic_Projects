...
training26= window(merged_final25, start = c(2017,6),
                  end = c(2021,2),
                  frequency = 12)

validation26= window(merged_final25, start = c(2021,3), end = c(2022,6))
...
stl_forecast26 = stlf(training26, h=length(validation26))

autoplot(stl_forecast26)

smape(stl_forecast26$mean, validation26) *100


plot(merged_final25, col="blue", type='l')

lines(stl_forecast26$mean, col="red", lwd=2)


#-------------------------------------------------------------------------------


ets_model26 = ets(training26,model="ZZZ" ,allow.multiplicative.trend = TRUE)


ets_forecast26 = forecast(ets_model26, h=length(validation26))

smape(ets_forecast26$mean, validation26) *100


plot(merged_final25, col="blue", type='l')

lines(ets_forecast26$mean, col="red", lwd=2)

#------TBATS-------

tbats_model26 = tbats(training26)

tbats_forecast26 = forecast(tbats_model26, h=length(validation26))

autoplot(tbats_forecast26)

smape(tbats_forecast26$mean, validation26) * 100
